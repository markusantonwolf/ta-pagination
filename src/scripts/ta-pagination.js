window.taPagination = () => {
    return {
        ...
        init(options) {
            ...
            this.$el.style.setProperty(`--ta-pagination-anim-duration`, this.options.duration + 'ms')
        ...
        checkMaxHeight() {
            ...
            if (typeof this.$refs[this.options.navigation] !== 'undefined') {
                ...
                this.$el.style.setProperty(`--ta-pagination-navigation-height`, `${navigation_height}px`)
            }
            ...
            this.$el.style.setProperty(`--${this.options.classItem}-height`, `${element_max_height}px`)
